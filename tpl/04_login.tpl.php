<header class="page-header"><h1><span class="icon-enter"></span> Einloggen</h1></header>
...
<form action="index.php?c=3&amp;login" method="post" class="form-horizontal" role="form">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<button type="submit" class="btn btn-default"><span class="icon-enter"></span> Einloggen</button>
		</div>
	</div>
</form>